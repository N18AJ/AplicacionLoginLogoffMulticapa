...
if (isset($_POST['guardar'])) {
    ...
    if ($entradaOK) { //si el valor es true procesamos los datos que hemos recogido   
        $codigo = $_SESSION["usuarioDAW2LoginLogoffMulticapaPOO"]->getCodUsuario();
        ...
        if (!is_null($objetoUsuario)) {
            ...
            $_SESSION["usuarioDAW2LoginLogoffMulticapaPOO"] = $objetoUsuario; //Carga el usuario en la sesión
